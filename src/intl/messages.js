...
export const messages: { [messageId: string]: MessageType } = {
  ...
  details: 'Details',
  disableTpmDevice: 'Disable TPM device?',
  ...
  poolStatus: '{allocatedVms} / {totalVms}',
  ...
  toggleViewForVirtualMachines: 'Toggle View',
  ...
  totalVirtualCpuInclude: 'The total virtual CPUs include:',
  tpm: {
    message: 'TPM',
    description: 'Trusted Platform Module',
  },
  tpmNotSupportedByTheSystem: 'The TPM device is not supported by the chosen operating system. Disabling the device will erase all stored data.',
