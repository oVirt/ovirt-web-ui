...
export const messages: { [messageId: string]: MessageType } = {
  ...
  SelectTheBootableDeviceTooltip: 'Select the bootable devices in the order you would like them to boot up in.',
  cancel: 'Cancel',
  ...
  diskEditorSizeCreateInfoTooltip: 'After creating a disk, you can only extend the size of it. The size of it will not be able to be decreased.',
