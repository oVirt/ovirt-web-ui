...
export const messages: { [messageId: string]: MessageType } = {
  ...
  remoteDesktopViewerConnection: 'Remote Desctop Viewer Connection',
  remoteDesktopViewerAvailable: 'Remote Desktop Viewer is available for most operating systems. To install it, search for it in GNOME Software or run the following:',
  remove: 'Remove',
