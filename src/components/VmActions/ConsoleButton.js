...
class ConsoleButton extends React.Component {
  ...
  consoleConfirmationAboutToOpen (e) {
    ...
    this.props.onCheckConsoleSessionInUse(
      this.props.vm.get('id'),
      this.props.userId,
      this.props.usbFilter
    )
  }
  ...
  onConsoleConfirmationClose () {
    ...
    this.props.onConsoleSessionConfirmClose(this.props.vm.get('id'))
  }
...
export default connect(
  ...
  (dispatch) => ({
    onCheckConsoleSessionInUse: (vmId, userId, usbFilter) => dispatch(checkConsoleInUse({ vmId, userId, usbFilter })),
    onConsoleSessionConfirmClose: (vmId) => dispatch(setConsoleInUse({ vmId, consoleInUse: false })),
    onDownloadConsole: (vmId, consoleId, usbFilter) => dispatch(downloadConsole({ vmId, consoleId, usbFilter })),
  })
)(ConsoleButton)
