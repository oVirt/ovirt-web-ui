...
export const ADD_POOLS_FETCHED_BY_ID = 'ADD_POOLS_FETCHED_BY_ID'
export const ADD_VMS_FETCHED_BY_ID = 'ADD_VMS_FETCHED_BY_ID'
...
export const REMOVE_POOLS_FETCHED_BY_ID = 'REMOVE_POOLS_FETCHED_BY_ID'
export const REMOVE_VM = 'REMOVE_VM'
export const REMOVE_VMS = 'REMOVE_VMS'
export const REMOVE_VMS_FETCHED_BY_ID = 'REMOVE_VMS_FETCHED_BY_ID'
export const RESTART_VM = 'RESTART_VM'
export const SAVE_CONSOLE_OPTIONS = 'SAVE_CONSOLE_OPTIONS'
export const SCHEDULER_FIXED_DELAY = 'SCHEDULER_FIXED_DELAY'
